function [initialEye,initialXCentroid,initialYCentroid,equivDiaSq] = initialIris(eye,fileList,fileNo)
...
eye2 = eye;
h_im = imshow(eye);
e = imellipse(gca,[200 100 1250 700]); % roughly the shape of an eye
BW = createMask(e,h_im);
eye2(BW==0)=150; % everything outside the mask is set to gray
eye = eye2;
...
%% Isolate & classify blobs again (if applicable)
...
% circular (eccentricity less than 0.71), get rid of less circular blobs
